"""
Test PPVC 14 model accuracy using first_trained_model.pth
...
def compare_predictions(expected_df, actual_df):
    ...
    # Save comparison
    comparison_path = 'ppvc14_prediction_comparison_firstmodel.csv'
...
def main():
    ...
    model_path = r"c:\Users\charm\Spatial GNN\model\5.OutputML_GAT_4CLASS 1st try\first_trained_model.pth"
    
    expected_csv = "ppvc14_expected_predictions.csv"
    actual_csv = "ppvc14_actual_predictions_firstmodel.csv"
    
    print("="*70)
    print("PPVC 14 Model Accuracy Test - Using first_trained_model.pth")
    print("="*70)
    
    # Step 1: Create expected predictions from annotations (reuse existing if available)
    import os
    ...
    print("\n" + "="*70)
    print(f"FINAL ACCURACY (first_trained_model): {accuracy:.2f}%")
    print("="*70)
