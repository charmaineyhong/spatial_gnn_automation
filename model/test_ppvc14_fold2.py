"""
Test PPVC 14 model accuracy using fold2_prettydecent.pth
...
def compare_predictions(expected_df, actual_df):
    ...
    # Save comparison
    comparison_path = 'ppvc14_prediction_comparison_fold2.csv'
...
def main():
    ...
    model_path = r"c:\Users\charm\Spatial GNN\model\fold2_prettydecent.pth"
    
    expected_csv = "ppvc14_expected_predictions.csv"
    actual_csv = "ppvc14_actual_predictions_fold2.csv"
    
    print("="*70)
    print("PPVC 14 Model Accuracy Test - Using fold2_prettydecent.pth")
    print("="*70)
    ...
    print("\n" + "="*70)
    print(f"FINAL ACCURACY (fold2_prettydecent): {accuracy:.2f}%")
    print("="*70)
