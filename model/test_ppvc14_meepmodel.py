"""
Test PPVC 14 model accuracy using meeptrained_model.pth
...
def compare_predictions(expected_df, actual_df):
    ...
    # Save comparison
    comparison_path = 'ppvc14_prediction_comparison_meepmodel.csv'
...
def main():
    ...
    model_path = r"c:\Users\charm\Spatial GNN\model\meeptrained_model.pth"
    
    expected_csv = "ppvc14_expected_predictions.csv"
    actual_csv = "ppvc14_actual_predictions_meepmodel.csv"
    
    print("="*70)
    print("PPVC 14 Model Accuracy Test - Using meeptrained_model.pth")
    print("="*70)
    ...
    print("\n" + "="*70)
    print(f"FINAL ACCURACY (meeptrained_model): {accuracy:.2f}%")
    print("="*70)
